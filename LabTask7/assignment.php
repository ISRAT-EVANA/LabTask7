...
<body>
		<div class="container">
			<ul class="nav nav-pills justify-content-center mt-5">
				...
				<li class="nav-items">
					<a class="nav-link active" href="http://localhost/My Project/Project/students/editProfile.p">Notice</a>
				</li>
				<li class="nav-items">
					<span class="nav-items"><a class="nav-link active" href="http://localhost/My Project/Project/students/logout.php">Logout</a></span>
				</li>
			</ul>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <table class="table">
					<tbody>
	                	...
	                	<tr>
	                		<td><a href='download.php?filename=<?php echo $assignment["fileName"]; ?>&dir=../assets/assignment/' style="text-decoration:none;"><?php echo $assignment["fileName"]; ?></a></td>
          ...
          <form>
		          <div class="col-md-3 text-center mt-3">
					<button type="button" class="btn btn-info btn-sm"><label for="file_field"> Upload Assignment</label></button>
